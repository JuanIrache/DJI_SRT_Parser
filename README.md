...
//toGeoJSON() exports the current interpretation of data to the geoJSON format. The optional value raw exports the raw data instead. You can then use tokml or togpx modules to convert to those formats
